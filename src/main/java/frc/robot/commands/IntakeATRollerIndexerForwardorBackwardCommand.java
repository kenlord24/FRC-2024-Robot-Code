...
public class IntakeATRollerIndexerForwardorBackwardCommand extends Command 
{
  ...
  public IntakeATRollerIndexerForwardorBackwardCommand(BlinkinSubsystem  BlinkinSubsystem,
  ...
  public boolean isFinished()
  {
    ...
    // {
        ...
        if(Analog0Subsystem.isAnalogIntakeSwitchClosed())
        {
              ...
              //This true will turn off the command 
              //I do not recommend 
              //let the a buton turn it off...
              // return true;
        }
    // }
    return false;
