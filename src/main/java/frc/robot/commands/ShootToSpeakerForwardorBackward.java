...
public class ShootToSpeakerForwardorBackward  extends Command 
{
  ...
  public ShootToSpeakerForwardorBackward(BlinkinSubsystem  BlinkinSubsystem,
  ...
  public void execute() 
    {
      ...
      SmartDashboard.putNumber("Shooter Velocity" , ShooterSubsystem.getShooterVelocity());
      
        if(ShooterSubsystem.getShooterVelocity() > 52.0)
        {
