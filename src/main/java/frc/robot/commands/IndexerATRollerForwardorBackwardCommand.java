...
public class IndexerATRollerForwardorBackwardCommand extends Command 
{
 ...
 private double  secondsToRun;
  ...
  public IndexerATRollerForwardorBackwardCommand(BlinkinSubsystem  BlinkinSubsystem,
  ...
  public void execute() 

    {
        ...
        ATRollerSubsystem.setATRollerPower(.5);
