...
public class AutoIndexerShooterForwardorBackwardCommand  extends Command 
{
  ...
  public AutoIndexerShooterForwardorBackwardCommand(BlinkinSubsystem  BlinkinSubsystem,
